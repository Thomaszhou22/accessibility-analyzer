    ...
    return (
      <div className="w-full max-w-4xl mx-auto space-y-4">
        ...
        <div className="flex items-center justify-center gap-2">
          ...
          <button
            className="text-sm font-medium px-4 py-2 rounded-lg transition-colors bg-primary text-white"
          >
            Batch Scan
          </button>
        </div>
          ...
          <div className="flex items-center gap-2 mb-4">
            <button
              ...
              className={`text-xs font-medium px-3 py-1.5 rounded-md transition-colors ${
                !showHtmlMode ? 'bg-primary/20 text-primary' : 'text-muted hover:text-foreground'
              }`}
            >
              URL Scanner
            </button>
              ...
              <>
                ...
                <div className="flex items-center gap-2">
                  <input
                    ...
                    autoCorrect="off"
                    spellCheck={false}
                    className="flex-1 h-9 rounded-lg border border-border bg-background px-3 py-1.5 text-xs text-foreground placeholder:text-muted transition-colors focus-visible:outline-none focus-visible:border-primary focus-visible:ring-2 focus-visible:ring-primary/20 disabled:cursor-not-allowed disabled:opacity-50"
                  />
                </div>
...
function HtmlExtractTips() {
  return (
    <div className="mt-2 text-xs text-muted leading-relaxed">
      <strong className="text-foreground">When to use this:</strong> URL scan blocked by bot detection, or page content is JS-rendered (React/Vue).
      <br />
      <strong className="text-foreground">How:</strong> Open the page in your browser, press <kbd className="px-1 py-0.5 rounded bg-surface text-[10px] font-mono border border-border">F12</kbd> → Elements tab → right-click <code className="text-accent">&lt;html&gt;</code> → Copy outerHTML. Paste here.
      <br />
